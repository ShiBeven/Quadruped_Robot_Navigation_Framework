#ifndef NAV2_PLUGINS__BT__CONTROL__RECOVERY_NODE_HPP_
#define NAV2_PLUGINS__BT__CONTROL__RECOVERY_NODE_HPP_
...
public:
  /**
   * @brief A constructor for nav2_plugins::RecoveryNode
  ...
  /**
   * @brief A destructor for nav2_plugins::RecoveryNode
   */
...
#endif  // NAV2_PLUGINS__BT__CONTROL__RECOVERY_NODE_HPP_
