#include "nav2_plugins/bt/action/hold_stop_flag.hpp"
...
: BT::StatefulActionNode(name, config), node_(getNodeFromBlackboard(*this))
{
  logger_ = node_->get_logger();
  node_->get_parameter("nav.decision_config.waypoint_stop_duration_s", hold_duration_s_);
...
{
  factory.registerNodeType<nav2_plugins::HoldStopFlagAction>("HoldStopFlag");
}
