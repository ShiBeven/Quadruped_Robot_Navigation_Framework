#include "nav2_plugins/bt/action/send_nav2_goal.hpp"

#include "nav2_plugins/bt/custom_types.hpp"
...
CreateRosNodePlugin(nav2_plugins::SendNav2GoalAction, "SendNav2Goal");
