...
def generate_launch_description():
    ...
    use_sensor_scan = LaunchConfiguration("use_sensor_scan")
    ...
    declare_use_sensor_scan_cmd = DeclareLaunchArgument(
        "use_sensor_scan",
        default_value="true",
        description="Whether to launch sensor_scan_generation",
    )
    ...
    load_nodes = GroupAction(
        ...
        actions=[
            ...
            Node(
                condition=IfCondition(use_sensor_scan),
    ...
    ld.add_action(declare_use_sensor_scan_cmd)
